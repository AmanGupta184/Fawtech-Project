...
function HomeContent() {
  return (
    <>
     <section id="home" className="bg-gray-50 dark:bg-gray-950 pt-20 pb-10 text-gray-800 dark:text-gray-100 flex items-center justify-center overflow-x-hidden">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-20">
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow-lg dark:shadow-gray-700 transform transition duration-300 hover:-translate-y-2 hover:shadow-xl dark:hover:shadow-gray-600">
