...
const AnimatedCounter = ({ end, suffix }) => {
  ...
  useEffect(() => {
    if (isInView) {
      ...
      const timer = setTimeout(() => setShouldStart(true), 100);
  ...
  return (
    <div ref={ref}>
      {shouldStart && <CountUp end={end} duration={2} />}
      {suffix}
    </div>
  );
};
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <motion.div custom={1} variants={itemVariants} className="space-y-6">
          ...
          <div className="space-y-4 text-base leading-relaxed text-gray-700 dark:text-gray-300">
            <p>
              At Fawtech, we believe technology should be fast, affordable, and
              everywhere.
            </p>
            <p>
              We empower businesses and gamers with cutting-edge electronics and
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300">
                ...
                IT peripherals, and innovative solutions across the globe. We're
                committed to technology that empowers businesses and lifestyles.
              </p>
            </motion.div>
          </motion.div>
        )}
