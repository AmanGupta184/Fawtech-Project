...
const ProductData = [
  ...
  },
  {
    ...
    images: [SurfacePro],
    description:
      "Ultra-portable 2-in-1 with Snapdragon power and built-in AI features.",
    specs:
      'Snapdragon X Elite, 16GB RAM, 512GB SSD, 13" PixelSense touchscreen, detachable keyboard',
  },
  {
    name: "Acer Nitro V",
    brand: "Acer",
