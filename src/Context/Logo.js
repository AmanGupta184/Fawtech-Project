...
export const Logo = [
  { id: 1, image: AsusLogo, className: "h-10 object-contain z-10" },
  { id: 2, image: JBLLogo, className: "h-14 object-contain z-10" },
  { id: 3, image: HPLogo, className: "h-14 object-contain z-10" },
  { id: 4, image: DysonLogo, className: "h-16 object-contain z-10" },
  { id: 5, image: LenovoLogo, className: "h-16 object-contain z-10" },
  { id: 6, image: LogitechLogo, className: "h-10 object-contain z-10" },
  { id: 7, image: XboxLogo, className: "h-14 object-contain z-10" },
  { id: 8, image: SonyLogo, className: "h-14 object-contain z-10" },
  { id: 9, image: PlayStationLogo, className: "h-16 object-contain z-10" },
  { id: 10, image: PnyLogo, className: "h-6 object-contain z-10" },
  { id: 11, image: MSILogo, className: "h-14 object-contain z-10" },
  { id: 12, image: NintendoLogo, className: "h-16 object-contain z-10" },
  { id: 13, image: AMDLogo, className: "h-12 object-contain z-10" },
  { id: 14, image: AcerLogo, className: "h-12 object-contain z-10" },
  { id: 15, image: AppleLogo, className: "h-14 object-contain z-10" },
  { id: 16, image: DellLogo, className: "h-28 object-contain z-10" },
  { id: 17, image: HarmonKardonLogo, className: "h-7 object-contain z-10" },
  { id: 18, image: IntelLogo, className: "h-14 object-contain z-10" },
  { id: 19, image: NvidiaLogo, className: "h-7 object-contain z-10" },
  { id: 20, image: ToshibaLogo, className: "h-14 object-contain z-10" },
  { id: 21, image: BoseLogo, className: "h-20 object-contain z-10" },
  { id: 21, image: AlienWareLogo, className: "h-24 object-contain z-10" },
];
