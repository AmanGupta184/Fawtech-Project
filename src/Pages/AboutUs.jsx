    ...
    <Layout>
      <div className="bg-gray-50 dark:bg-gray-900 min-h-screen p-4 md:p-8 transition-colors duration-300">
        ...
        <header className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-800 dark:text-white mt-16 mb-8">About Fawtech</h2>
        ...
        <section className="grid md:grid-cols-2 gap-8 mb-12 max-w-6xl mx-auto">
          <div>
            <h2 className="text-2xl md:text-3xl font-semibold text-gray-800 dark:text-white mb-4">Our Mission</h2>
          ...
          <div className="flex items-center justify-center">
            <img
              src={Image}
              alt="Electronics Lab"
              className="w-80 h-52 rounded-lg shadow-lg"
            />
          </div>
        </section>
        ...
        <section className="max-w-6xl mx-auto mb-12 px-4">
          <h2 className="text-2xl md:text-3xl font-semibold text-center mb-8 text-gray-800 dark:text-white">Meet Our Team</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {teamMembers.map((member) => (
              <div
                key={member.name}
                className="bg-white dark:bg-gray-800 p-4 md:p-6 rounded-lg shadow hover:shadow-xl transition duration-300 text-center"
              >
                <img
                  src={member.image}
                  alt={member.name}
                ...
                />
                <h3 className="text-xl md:text-2xl font-semibold text-gray-800 dark:text-white mb-2">{member.name}</h3>
        ...
        <section className="max-w-4xl mx-auto mb-12 px-4">
          <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-800 dark:text-white">Our Product Portfolio</h2>
          <ul className="list-disc list-inside space-y-4 text-gray-800 dark:text-gray-300 text-sm md:text-base">
            <li>
        ...
        {/* Call to Action */}
        <section className="bg-white dark:bg-gray-800 text-black dark:text-white py-8 px-4 md:py-12 md:px-8 text-center shadow-lg rounded-lg max-w-4xl mx-auto mb-12">
          ...
          <a
            href="/contact"
            className="bg-gray-100 dark:bg-gray-700 text-black dark:text-white font-semibold py-2 px-4 md:py-3 md:px-6 rounded hover:bg-gray-200 dark:hover:bg-gray-600 transition duration-300"
          >
            Contact Us
          </a>
        </section>
