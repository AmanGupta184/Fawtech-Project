      ...
      <section className="max-w-6xl mx-auto py-12 px-4">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Noor has positioned FawTech to deliver innovation and reliability across global markets.
          </p>
        </motion.div>
      </section>
      ...
      <section className="max-w-6xl mx-auto py-12 px-4">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              We are committed to providing cutting-edge electronic products that combine technology, quality, and affordability.
            </p>
            <p className="text-gray-600 dark:text-gray-300">
          ...
          >
            <img src={Image} alt="Electronics Lab" className="w-full max-w-md rounded-xl shadow-lg object-cover h-64" />
          </motion.div>
        </div>
      </section>
            ...
            {Logo.map((logo) => (
              <SwiperSlide key={logo.id}>
                <div className="relative flex justify-center items-center h-32 transform transition-transform duration-500 hover:scale-110">
                  ...
                  <img src={logo.image} alt={`Logo ${logo.id}`} className="h-20 object-contain z-10" />
                </div>
              </SwiperSlide>
            ))}
          </Swiper>
