...
function AboutUs() {
  return (
    <Layout>
      <div className="bg-gray-50 mt-10 md:mt-0 dark:bg-gray-900 min-h-screen transition-colors duration-300">
        {/* Hero Header */}
          ...
          <div className="relative max-w-6xl mx-auto px-4 text-center">
            ...
            <div className="max-w-3xl mx-auto space-y-4 text-gray-600 dark:text-gray-200 text-base md:text-lg">
              ...
              <p>
                ...
                JAFZA for efficient global distribution. Our worldwide customer
                base reflects our commitment to delivering feature-rich,
                professional products at competitive prices.
              </p>
              <p>
        ...
        <section className="max-w-6xl mx-auto py-12 px-4">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-8 transform hover:scale-105 transition-transform duration-300">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              ...
              In just three months, Noor’s vision has propelled FawTech to
              become a dynamic player in the electronics industry, focusing on
              high-quality tech products and exceptional service.
            </p>
            <p className="text-gray-600 dark:text-gray-300">
              With a strong commitment to serving international clients, Noor
              has positioned FawTech to deliver innovation and reliability
              across global markets, setting the foundation for our rapid growth
        ...
        <section className="max-w-6xl mx-auto py-12 px-4">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl p-8 transform hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                At ElectroTech, we are committed to providing cutting-edge
                electronic products that combine technology, quality, and
                affordability.
              </p>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            {[
              {
                ...
                description:
                  "We offer a range of gaming consoles from top manufacturers, including PlayStation, Xbox, and Nintendo. Whether you’re a casual gamer or a hardcore enthusiast, we’ve got the perfect console for you.",
              },
              {
                title: "Dyson Products",
                description:
                  "Our selection includes Dyson vacuums, air purifiers, and more. Known for innovative design and performance, these products make your life easier and more enjoyable.",
              },
              {
                title: "Graphic Cards",
                description:
